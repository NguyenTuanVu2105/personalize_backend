...
class Migration(migrations.Migration):
    dependencies = [
        ...
        # modify this.
        ('billing', '0039_auto_20201208_1647'),
    ]
    ...
    migration = '''
        ...
        begin
            ...
            new.tsv_metadata_search := setweight(to_tsvector(coalesce(new.id::text)), 'A') || setweight(to_tsvector(coalesce(user_email)), 'A');
        return new;
        end
        $$ LANGUAGE plpgsql;

        CREATE TRIGGER transaction_tsv_metadata_search_update BEFORE INSERT OR UPDATE
